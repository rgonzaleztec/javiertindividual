...
public class ObjectController : MonoBehaviour
{
    ...
    private void LevantarBasura(bool gazedAt)
    {
        /// Levanta la basura
    }

    private void BajarBasura(bool gazedAt)
    {
        /// Baja la basura
    }

    private void LevantarHerramienta(bool gazedAt)
    {
        /// Levanta la basura
    }

    private void BajarHerramienta(bool gazedAt)
    {
        /// Baja la herramienta
    }

    private void LevantarCaja(bool gazedAt)
    {
        /// Levanta la caja
    }

    private void BajarCaja(bool gazedAt)
    {
        /// Baja la caja
    }
}
